 ...
 * Generated at: 2025-01-03 13:00:44 UTC
...
public final class write_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\t// 글 작성\r\n");
      out.write("\tfunction writeProcess() {\r\n");
      out.write("\r\n");
      out.write("\t\tvar maxLength = 50; \r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar title = $(\"#title\").val();\r\n");
      out.write("\r\n");
      out.write("\t\tvar content = $(\"#content\").val();\r\n");
      out.write("\r\n");
      out.write("\t\tvar formData = new FormData($('#writePostDTO')[0]);\r\n");
      out.write("\r\n");
      out.write("\t\tif (title == \"\") {\r\n");
      ...
      out.write("\t\tif (yn) {\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif($(\"#title\").val().length > maxLength){\r\n");
      out.write("\t\t\t\talert(\"제목은 글자수 50까지만 가능합니다. \");\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\r\n");
      out.write("\t\t\t} else {\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t<h4 class=\"card-title\">글쓰기</h4>\r\n");
      out.write("\t\t\t\t\t\t<form id=\"writePostDTO\" name=\"writePostDTO\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<label for=\"title\">제목</label> <input type=\"text\" id=\"title\" name=\"title\" class=\"form-control\" />\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"content\">내용</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<textarea id=\"content\" name=\"content\" class=\"form-control\" rows=\"10\" style=\"resize: none\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 이미지 첨부파일 시작-->\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- private String imageFileName; //업로드한 사진의 이름\r\n");
      out.write("\t\t\t\t\t\t private MultipartFile imageFile; //업로드한 사진파일  -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"imageFile\">첨부 이미지</label> \r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"file\" id=\"imageFile\" name=\"imageFile\" class=\"form-control\" accept=\"image/*\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- 이미지 첨부파일 끝 -->\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"text-right\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-secondary btn-sm\" onclick=\"javascript:goMain();\">목록으로</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-info btn-sm\" onclick=\"javascript:writeProcess();\">등록하기</button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/view/board/write.jsp(3,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("root");
      // /WEB-INF/view/board/write.jsp(3,0) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/WEB-INF/view/board/write.jsp(3,0) '${pageContext.request.contextPath }/'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${pageContext.request.contextPath }/",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fimport_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/view/board/write.jsp(101,0) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fimport_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/view/board/write.jsp(142,0) name = url type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null

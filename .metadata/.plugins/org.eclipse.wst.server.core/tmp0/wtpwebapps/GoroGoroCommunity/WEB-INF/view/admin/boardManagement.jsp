					...
					alert(obj); 
							...
							if (obj != null) {
								...
								if (result == null) {
									...
									alert("해당 카테고리 안에 그 게시판의 이름은 이미 존재하기에 사용불가합니다. 이동 할수 없습니다.");
									return false; 
...
<c:import url="/WEB-INF/view/include/topMenu.jsp" />
	...
	<div style="padding-top: 50px; padding-bottom: 50px;">
		<div class="container">
			...
			<form action="${root }admin/boardManagement/deleteBoard" style="padding-top: 10px; padding-bottom: 20px;">
				3) 게시판 제거<br>
				(1) 삭제할 게시판 선택: 
			...
			<form id="categoryDTOtoChange" method="post" style="padding-top: 20px; padding-bottom: 10px;">
				...
				<select name="boardCategoryNo"style="width: 300px;">
					...
					<button type="button" class="btn btn-warning btn-sm" style="text-align: right;" onClick="changeCategory();">해당 게시판의 카테고리 변경하기</button>
				<br>
			</form>

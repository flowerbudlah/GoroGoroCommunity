					...
					<div class="card-body">
						...
						<p>
							...
							신고가 접수된 게시물은 관리자의 판단 하에 처리되며, 법적처벌을 받을 수도 있습니다.
							 -->
							If you submit a report using the proper form, <strong>the
								post (Post Index: ${postNo})</strong> will be reported to the
							administrator. Once received, the report will be reviewed at the
							administrator's discretion, and legal action may be taken if
							necessary.
						</p>
						<form id="submitReportDTO" name="submitReportDTO" method="post"
							...
							<div class="form-group">
								<label>Reporter</label> <input type="text"
									value="${signInMemberDTO.nick }" class="form-control" disabled />
							</div>
							<div class="form-group">
								<label>Recipient</label> <input type="text"
									value="Administrator" class="form-control" disabled />
							</div>
							<div class="form-group">
								<label for="reason">Reason for Report</label> <select
									name="reason" id="reason" class="form-control">
									<!-- 
									...
									<option value="기타(해당 게시판의 주제와 맞지않는내용 등)">기타(해당 게시판의 주제와 맞지않는내용 등)</option>
									 -->
									<option
										value="Defamation, insults, slander, spreading false information">Defamation,
										insults, slander, spreading false information</option>
									<option value="Advertisements, spam, etc.">Advertisements,
										spam, etc.</option>
									<option value="Pornographic content">Pornographic
										content</option>
									<option value="Invasion of privacy">Invasion of
										privacy</option>
									<option value="Copyright infringement">Copyright
										infringement</option>
									<option value="Other (Off-topic content, etc.)">Other
										(Off-topic content, etc.)</option>
							...
							<div class="form-group">
								<label for="imageFile">Attached Image(s)</label> <input
						...
						<div class="form-group">
							<div class="text-right">
								<button type="button" class="btn btn-secondary btn-sm"
									onclick="javascript:history.back();">Go Back to
									Previous Page</button>
								<button type="button" class="btn btn-info btn-sm"
									onClick="javascript:reportProcess();">Submit to

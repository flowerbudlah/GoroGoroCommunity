...
<!-- 그 게시판 윗 부분 그림 -->
<article class="slider"><img src="/GoroGoroCommunity/image/candy02.jpg"></article>
	<!-- 본문 -->
				...
				<div class="card shadow-none">
					<div class="card-body">
						...
						<div class="form-group">
							<label for="postNo">글번호</label> <input type="text" id="postNo" name="postNo" class="form-control" value="${readPostDTO.postNo}" disabled="disabled" />
